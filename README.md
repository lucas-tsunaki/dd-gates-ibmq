...
This repository contains the basic functions for executing the DD-gate with IBMQ and simulating them with Qiskit, as presented in 'Quantum Gates via Dynamical Decoupling of Central Qubit on IBMQ and 15NV Center in Diamond' by L. Tsunaki et al., available at: [arXiv:2508.22107](https://arxiv.org/abs/2509.22107).
